--------------------------------------------------------
--  DDL for Procedure LOAD_DIAG_DP_LINE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SNX_IWS2"."LOAD_DIAG_DP_LINE" 
  -- Program name - LOAD_DIAG_DP_LINE
  -- Created 11-18-2011 R Benzell
  -- Called by LOAD_DIAG_DATAPOINTS programs to process each DP line
  -- Update History
  --  
  --
           (
          ...
          BEGIN
            Insert into PAGES
             ...
             (P_CASEID,
              ...
              systimestamp,
              1,  -- subDocumentOrder   =
              1, --subDocumentPageNumber=
              v_page, --finalpagenumber =originalpagenumber,
             'N', -- isdeleted            =
             'Y', --iscompleted          =
              0, --orientation          =
             'N', --hasdatapoint=
             'N', --isbadhandwriting=
             'SP0000012418', --SPCONTENTID='
             13079  --did=
             );
