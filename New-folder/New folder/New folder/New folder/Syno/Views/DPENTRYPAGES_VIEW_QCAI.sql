CREATE OR REPLACE FORCE VIEW "SNX_IWS2"."DPENTRYPAGES_VIEW_QCAI" ("CASEID", "CATEGORY", "SUBCATEGORY", "CODENAME", "CODETYPE", "CODEDESC", "FINALPAGENUMBER", "SECTIONNUMBER", "STARTSECTIONNUMBER", "ENDSECTIONNUMBER", 
"DATADATE", "DPENTRYID", "HID", "SEQUENCE", "STATUS", "DATAFIELD1", "DATAFIELD1TYPE", "DATAFIELD1REF", "DATAFIELD1VALUE", "DATAFIELD2", "DATAFIELD2TYPE", "DATAFIELD2REF", "DATAFIELD2VALUE", 
...
"DATAFIELD9", "DATAFIELD9TYPE", "DATAFIELD9REF", "DATAFIELD9VALUE", "DATAFIELD10", "DATAFIELD10TYPE", "DATAFIELD10REF", "DATAFIELD10VALUE", "DATAFIELD11", "DATAFIELD11TYPE",
  "DATAFIELD11REF", "DATAFIELD11VALUE", "DATAFIELD12", "DATAFIELD12TYPE", "DATAFIELD12REF", "DATAFIELD12VALUE", "DATAFIELD13", "DATAFIELD13TYPE", "DATAFIELD13REF", "DATAFIELD13VALUE", 
...
"DATAFIELD19", "DATAFIELD19TYPE", "DATAFIELD19REF", "DATAFIELD19VALUE", "DATAFIELD20", "DATAFIELD20TYPE", "DATAFIELD20REF", "DATAFIELD20VALUE", "ISCRITICAL", "CRITICALITY", 
  "ICD10CMCODE", "ICD9CODE", "CPTCODE", "ICD10PCSCODE", "MIBDATECODE", "MIBCODE", "MESHCODE", "ISDELETED", "SUSPENDNOTE", "USERFEEDBACK", 
...
AS
  SELECT p.CASEID,
    ...
    dpe.SUSPENDNOTE,
    dpe.USERFEEDBACK,
    TO_CHAR (dpe.CREATED_TIMESTAMP, 'YYYY-MM-DD HH24:MI.SS') AS CREATED_TIMESTAMP,
    dpe.CREATED_USERID,
    Dpe.Created_Stageid,
    TO_CHAR (dpe.UPDATED_TIMESTAMP, 'YYYY-MM-DD HH24:MI.SS') AS UPDATED_TIMESTAMP,
    dpe.UPDATED_USERID,
    dpe.UPDATED_STAGEID,
    dpe.debit_value,
    dpe.credit_value,
    dpe.isfinal,
    code.DATAFIELD21,  --IWN-1178 Add 12 more data fields to related database tables and views
