--------------------------------------------------------
--  DDL for Function CASE_OP_ENTRY_USERS
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "SNX_IWS2"."CASE_OP_ENTRY_USERS" 
    (P_CASEID NUMBER,
    ...
    -- Includes Step2-OP and Transcription
     ...
     BEGIN
         ...
         (
             ...
             where caseid=P_CASEID
                and actionid = 17
                and stageid not in (4,5,7,48,50)
