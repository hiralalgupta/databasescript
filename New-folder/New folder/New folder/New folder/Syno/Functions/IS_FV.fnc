--------------------------------------------------------
--  DDL for Function IS_FV
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "SNX_IWS2"."IS_FV" 
    (     P_ACCESS varchar2 default NULL)
    
    -- Created 9-21-2012 R Benzell
    -- Returns a Boolean indicating where the APEX current :USERID is an Infopath FileViewer or not
