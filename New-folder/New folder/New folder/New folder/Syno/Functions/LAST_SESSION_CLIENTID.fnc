--------------------------------------------------------
--  DDL for Function LAST_SESSION_CLIENTID
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "SNX_IWS2"."LAST_SESSION_CLIENTID" 
    ...
    --    SELECT LAST_SESSION_CLIENTID(4,12724, 8613951154071948) from dual
